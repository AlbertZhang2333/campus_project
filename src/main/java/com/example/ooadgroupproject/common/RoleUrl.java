...
public class RoleUrl {
    private static final String ROLE_ANONYMOUS = "(/UserShopping/AlipayNotify|/UserShopping/AliPayReturn|login/getAccountInfo|/login/logout|/login/loginCheck|/login/register|/login/forgetPassword" +
            ...
            "|/nearbyStop|/searchingBusStop|/allRelation|/startEndRelation/|/searchByStartOrEnd/|/allShowBuilding)";
    private static final String ROLE_USER = "(/login|/UserShopping|/UserCheckShoppingRecord|/Reservation|" +
            "/Comment/addComment|/Comment/updateComment|/ChatController/userSendMessageToAdmin|/uploadImage/image)";
