...
public class PayTool {
    ...
    public static String RETURN_URL="http://4h5c6u.natappfree.cc/UserShopping/AliPayReturn";
    public static String NOTIFY_URL="http://4h5c6u.natappfree.cc/UserShopping/AlipayNotify";
