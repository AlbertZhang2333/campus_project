...
public class PayTool {
    ...
    public static String RETURN_URL="http://apet65.natappfree.cc/UserShopping/AliPayReturn";
    public static String NOTIFY_URL="http://apet65.natappfree.cc/UserShopping/AlipayNotify";
