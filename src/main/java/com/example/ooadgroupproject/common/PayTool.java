...
public class PayTool {
    ...
    public static String RETURN_URL="http://7bspiv.natappfree.cc/UserShopping/AliPayReturn";
    public static String NOTIFY_URL="http://7bspiv.natappfree.cc/UserShopping/AlipayNotify";
